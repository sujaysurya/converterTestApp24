#!/usr/bin/env python3
"""
appian_add_members_to_group_converter.py
========================================
Converts Appian 'Add members to Group' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Add members to Group"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'identityManagementService', 'operation': 'addGroupMembers', 'return_type': 'boolean'}

PARAMETER_SCHEMA = {'group': 'target group', 'users': 'users to add'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-add_members_to_group",
        node_name="Demo Add members to Group",
        node_type=NODE_TYPE_LABEL,
        parameters={'group': '"Loan Approvers"', 'users': 'pv!newApproverList'},
