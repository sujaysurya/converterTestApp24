#!/usr/bin/env python3
"""
appian_and_converter.py
=======================
Converts Appian 'AND' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Standard Appian parallel gateway -- accurate.
...
EXTRA_CONFIG = {'mode': 'and'}

PARAMETER_SCHEMA = {'<branchName>': 'one parameter per parallel outgoing flow'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        ...
        parameters={'notifyCustomer': 'true', 'updateLedger': 'true'},
