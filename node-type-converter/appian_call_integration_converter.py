#!/usr/bin/env python3
"""
appian_call_integration_converter.py
====================================
Converts Appian 'Call Integration' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Call Integration"
NODE_CATEGORY = "INTEGRATION_CALL"
EXTRA_CONFIG = {}

PARAMETER_SCHEMA = {'integrationObject': 'referenced Integration design object', 'inputMapping': 'SAIL expression for the request body/params'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-call_integration",
        node_name="Demo Call Integration",
        node_type=NODE_TYPE_LABEL,
        parameters={'integrationObject': '"CreditBureauLookup"', 'inputMapping': 'a!map(ssn: pv!ssn, threshold: rule!demoBusinessRule(balance: pv!currentBalance))'},
