#!/usr/bin/env python3
"""
appian_combine_excel_sheet_converter.py
=======================================
Converts Appian 'Combine Excel Sheet' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Combine Excel Sheet"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'fileProcessingService', 'operation': 'combineExcelSheets', 'return_type': 'Document'}

PARAMETER_SCHEMA = {'sourceDocuments': 'excel documents/sheets to combine'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-combine_excel_sheet",
        node_name="Demo Combine Excel Sheet",
        node_type=NODE_TYPE_LABEL,
        parameters={'sourceDocuments': 'pv!excelDocs'},
