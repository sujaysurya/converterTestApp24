#!/usr/bin/env python3
"""
appian_complex_converter.py
===========================
Converts Appian 'Complex' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Standard Appian complex gateway -- accurate.
...
NODE_TYPE_LABEL = "Complex"
NODE_CATEGORY = "GATEWAY"
EXTRA_CONFIG = {'mode': 'complex'}

PARAMETER_SCHEMA = {'<branchName>': 'one parameter per outgoing flow (boolean condition)', 'joinCondition': 'SAIL expression evaluated to decide whether the gateway proceeds'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-complex",
        node_name="Demo Complex",
        node_type=NODE_TYPE_LABEL,
        parameters={'pathA': 'true', 'pathB': 'false', 'joinCondition': 'true'},
