#!/usr/bin/env python3
"""
appian_consume_from_kafka_deprecated_converter.py
=================================================
Converts Appian 'Consume from Kafka [Deprecated]' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Deprecated + custom -- placeholder schema, verify, and confirm still-in-use before converting.
...
NODE_TYPE_LABEL = "Consume from Kafka [Deprecated]"
NODE_CATEGORY = "KAFKA_CONSUME"
EXTRA_CONFIG = {'deprecated': True}

PARAMETER_SCHEMA = {'topic': 'TODO: confirm actual parameter name', 'consumerGroup': 'TODO: confirm actual parameter name'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-consume_from_kafka_deprecated",
        node_name="Demo Consume from Kafka [Deprecated]",
        node_type=NODE_TYPE_LABEL,
        parameters={'topic': '"legacy-events"', 'consumerGroup': '"legacy-group"'},
