#!/usr/bin/env python3
"""
appian_create_folder_converter.py
=================================
Converts Appian 'Create Folder' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Well-documented Document Management plugin -- accurate.
...
NODE_TYPE_LABEL = "Create Folder"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'documentManagementService', 'operation': 'createFolder', 'return_type': 'Long'}

PARAMETER_SCHEMA = {'folderName': 'new folder name', 'parentFolder': 'parent folder', 'description': 'optional description'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-create_folder",
        node_name="Demo Create Folder",
        node_type=NODE_TYPE_LABEL,
        parameters={'folderName': 'pv!customerId', 'parentFolder': '"/Customers"'},
