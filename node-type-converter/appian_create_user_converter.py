#!/usr/bin/env python3
"""
appian_create_user_converter.py
===============================
Converts Appian 'Create User' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Create User"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'identityManagementService', 'operation': 'createUser', 'return_type': 'String'}

PARAMETER_SCHEMA = {'username': 'new username', 'email': "new user's email", 'group': 'initial group membership'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-create_user",
        node_name="Demo Create User",
        node_type=NODE_TYPE_LABEL,
        parameters={'username': 'pv!newUsername', 'email': 'pv!newUserEmail', 'group': '"Employees"'},
