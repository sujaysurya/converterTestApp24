#!/usr/bin/env python3
"""
appian_database_access_converter.py
===================================
Converts Appian 'Database Access' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Generic DB access smart service -- reasonable generic guess, verify against export.
...
NODE_TYPE_LABEL = "Database Access"
NODE_CATEGORY = "STORED_PROC"
EXTRA_CONFIG = {}

PARAMETER_SCHEMA = {'query': 'SQL/SAIL query expression', 'dataSource': 'JDBC connected system'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-database_access",
        node_name="Demo Database Access",
        node_type=NODE_TYPE_LABEL,
        parameters={'query': '"SELECT * FROM ACCOUNT WHERE ID = ?"', 'dataSource': '"CoreBankingDS"'},
