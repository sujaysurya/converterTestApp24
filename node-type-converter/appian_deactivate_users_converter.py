#!/usr/bin/env python3
"""
appian_deactivate_users_converter.py
====================================
Converts Appian 'Deactivate Users' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Deactivate Users"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'identityManagementService', 'operation': 'deactivateUsers', 'return_type': 'boolean'}

PARAMETER_SCHEMA = {'users': 'users to deactivate'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-deactivate_users",
        node_name="Demo Deactivate Users",
        node_type=NODE_TYPE_LABEL,
        parameters={'users': 'pv!offboardedUsers'},
