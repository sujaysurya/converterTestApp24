#!/usr/bin/env python3
"""
appian_delete_data_store_entries_converter.py
=============================================
Converts Appian 'Delete and Data Store Entries' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Delete and Data Store Entries"
NODE_CATEGORY = "DATA_STORE_DELETE"
EXTRA_CONFIG = {}

PARAMETER_SCHEMA = {'dataStoreEntity': 'target Data Store Entity', 'filterCriteria': 'SAIL expression identifying which records to delete'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-delete_data_store_entries",
        node_name="Demo Delete and Data Store Entries",
        node_type=NODE_TYPE_LABEL,
        parameters={'dataStoreEntity': '"StaleSession"', 'filterCriteria': 'rule!demoBusinessRule(balance: pv!currentBalance)'},
