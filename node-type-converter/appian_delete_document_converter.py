#!/usr/bin/env python3
"""
appian_delete_document_converter.py
===================================
Converts Appian 'DeleteDocument' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Well-documented AppMarket Document Management plugin -- accurate at operation level.
...
NODE_TYPE_LABEL = "DeleteDocument"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'documentManagementService', 'operation': 'deleteDocument', 'return_type': 'boolean'}

PARAMETER_SCHEMA = {'document': 'document to delete (id/UUID)'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-delete_document",
        node_name="Demo DeleteDocument",
