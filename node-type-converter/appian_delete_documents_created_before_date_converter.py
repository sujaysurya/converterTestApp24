#!/usr/bin/env python3
"""
appian_delete_documents_created_before_date_converter.py
========================================================
Converts Appian 'Delete Documents Created Before Date' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Document Management plugin -- verify; could also be a custom retention-policy build.
...
NODE_TYPE_LABEL = "Delete Documents Created Before Date"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'documentManagementService', 'operation': 'deleteDocumentsCreatedBeforeDate', 'return_type': 'int'}

PARAMETER_SCHEMA = {'folder': 'folder to scan', 'cutoffDate': 'SAIL expression for the cutoff date'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-delete_documents_created_before_date",
        node_name="Demo Delete Documents Created Before Date",
        node_type=NODE_TYPE_LABEL,
        parameters={'folder': '"/Temp"', 'cutoffDate': 'today() - 90'},
