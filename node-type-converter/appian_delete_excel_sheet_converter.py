#!/usr/bin/env python3
"""
appian_delete_excel_sheet_converter.py
======================================
Converts Appian 'Delete Excel Sheet' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Excel/CSV utility plugin -- accurate at operation level.
...
NODE_TYPE_LABEL = "Delete Excel Sheet"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'fileProcessingService', 'operation': 'deleteExcelSheet', 'return_type': 'boolean'}

PARAMETER_SCHEMA = {'document': 'source excel document', 'sheetName': 'sheet to delete'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-delete_excel_sheet",
        node_name="Demo Delete Excel Sheet",
        node_type=NODE_TYPE_LABEL,
        parameters={'document': 'pv!excelDoc', 'sheetName': '"Sheet2"'},
