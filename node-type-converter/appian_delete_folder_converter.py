#!/usr/bin/env python3
"""
appian_delete_folder_converter.py
=================================
Converts Appian 'Delete Folder' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Delete Folder"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'documentManagementService', 'operation': 'deleteFolder', 'return_type': 'boolean'}

PARAMETER_SCHEMA = {'folder': 'folder to delete'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-delete_folder",
        node_name="Demo Delete Folder",
        node_type=NODE_TYPE_LABEL,
        parameters={'folder': '"/Customers/Temp"'},
