#!/usr/bin/env python3
"""
appian_delete_records_and_related_records_converter.py
======================================================
Converts Appian 'Delete Records and Related Records' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Standard Records concept -- accurate.
...
NODE_TYPE_LABEL = "Delete Records and Related Records"
NODE_CATEGORY = "DATA_STORE_DELETE"
EXTRA_CONFIG = {}

PARAMETER_SCHEMA = {'recordType': 'target Record Type', 'filterCriteria': 'SAIL expr identifying records (and related) to delete'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-delete_records_and_related_records",
        node_name="Demo Delete Records and Related Records",
        node_type=NODE_TYPE_LABEL,
        parameters={'recordType': '"Account"', 'filterCriteria': 'rule!demoBusinessRule(balance: pv!currentBalance)'},
