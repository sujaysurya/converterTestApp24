#!/usr/bin/env python3
"""
appian_document_zipper_converter.py
===================================
Converts Appian 'Document Zipper' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Document Zipper"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'documentManagementService', 'operation': 'zipDocuments', 'return_type': 'Document'}

PARAMETER_SCHEMA = {'documents': 'documents to zip', 'zipFileName': 'output zip file name'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-document_zipper",
        node_name="Demo Document Zipper",
        node_type=NODE_TYPE_LABEL,
        parameters={'documents': 'pv!documentList', 'zipFileName': '"statements.zip"'},
