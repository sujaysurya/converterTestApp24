#!/usr/bin/env python3
"""
appian_end_node_converter.py
============================
Converts Appian 'End Node' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "End Node"
NODE_CATEGORY = "END_NODE"
EXTRA_CONFIG = {}

PARAMETER_SCHEMA = {'<outputName>': 'one parameter per process output variable'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-end_node",
        node_name="Demo End Node",
        node_type=NODE_TYPE_LABEL,
        parameters={'summary': 'rule!demoBusinessRule(balance: pv!currentBalance)'},
