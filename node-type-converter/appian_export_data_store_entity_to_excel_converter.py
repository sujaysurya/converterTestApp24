#!/usr/bin/env python3
"""
appian_export_data_store_entity_to_excel_converter.py
=====================================================
Converts Appian 'Export Data Store Entity to Excel' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Export Data Store Entity to Excel"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'fileProcessingService', 'operation': 'exportDataStoreEntityToExcel', 'return_type': 'Document'}

PARAMETER_SCHEMA = {'dataStoreEntity': 'source entity', 'filterCriteria': 'SAIL filter expression'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-export_data_store_entity_to_excel",
        node_name="Demo Export Data Store Entity to Excel",
