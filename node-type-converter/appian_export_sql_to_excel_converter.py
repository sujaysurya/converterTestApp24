#!/usr/bin/env python3
"""
appian_export_sql_to_excel_converter.py
=======================================
Converts Appian 'Export SQL To Excel' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Plugin/custom -- verify.
...
NODE_TYPE_LABEL = "Export SQL To Excel"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'fileProcessingService', 'operation': 'exportSqlToExcel', 'return_type': 'Document'}

PARAMETER_SCHEMA = {'sqlQuery': 'query to export', 'dataSource': 'JDBC connected system'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-export_sql_to_excel",
        node_name="Demo Export SQL To Excel",
        node_type=NODE_TYPE_LABEL,
        parameters={'sqlQuery': '"SELECT * FROM ACCOUNT"', 'dataSource': '"CoreBankingDS"'},
