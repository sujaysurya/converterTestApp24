#!/usr/bin/env python3
"""
appian_extract_zip_converter.py
===============================
Converts Appian 'Extract Zip' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Extract Zip"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'documentManagementService', 'operation': 'extractZip', 'return_type': 'java.util.List'}

PARAMETER_SCHEMA = {'zipDocument': 'zip document to extract', 'targetFolder': 'destination folder'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-extract_zip",
        node_name="Demo Extract Zip",
        node_type=NODE_TYPE_LABEL,
        parameters={'zipDocument': 'pv!uploadedZip', 'targetFolder': '"/Extracted"'},
