#!/usr/bin/env python3
"""
appian_foldersecurity_converter.py
==================================
Converts Appian 'FolderSecurity' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Document Management plugin -- verify exact role-map shape against your export.
...
NODE_TYPE_LABEL = "FolderSecurity"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'documentManagementService', 'operation': 'setFolderSecurity', 'return_type': 'boolean'}

PARAMETER_SCHEMA = {'folder': 'target folder', 'securityRoleMap': 'SAIL expr mapping roles/users to permissions'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-foldersecurity",
        node_name="Demo FolderSecurity",
        node_type=NODE_TYPE_LABEL,
        parameters={'folder': '"/Customers"', 'securityRoleMap': 'pv!roleMap'},
