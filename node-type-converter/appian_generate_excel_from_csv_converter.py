#!/usr/bin/env python3
"""
appian_generate_excel_from_csv_converter.py
===========================================
Converts Appian 'Generate Excel from CSV' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Generate Excel from CSV"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'fileProcessingService', 'operation': 'generateExcelFromCsv', 'return_type': 'Document'}

PARAMETER_SCHEMA = {'csvDocument': 'source CSV document', 'sheetName': 'target sheet name'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-generate_excel_from_csv",
        node_name="Demo Generate Excel from CSV",
        node_type=NODE_TYPE_LABEL,
        parameters={'csvDocument': 'pv!csvDoc', 'sheetName': '"Accounts"'},
