#!/usr/bin/env python3
"""
appian_generate_text_converter.py
=================================
Converts Appian 'Generate Text' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Best-effort -- likely an AI/document-generation smart service; verify actual parameter names.
...
NODE_TYPE_LABEL = "Generate Text"
NODE_CATEGORY = "AI_TEXT"
EXTRA_CONFIG = {}

PARAMETER_SCHEMA = {'promptTemplate': 'SAIL expression building the prompt', 'inputData': 'supporting input data'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-generate_text",
        node_name="Demo Generate Text",
        node_type=NODE_TYPE_LABEL,
        parameters={'promptTemplate': '"Summarize: " & pv!notes', 'inputData': 'rule!demoBusinessRule(balance: pv!currentBalance)'},
