#!/usr/bin/env python3
"""
appian_get_base64_document_from_database_converter.py
=====================================================
Converts Appian 'Get Base64 Document from Database' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Likely custom/internal -- verify.
...
NODE_TYPE_LABEL = "Get Base64 Document from Database"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'documentManagementService', 'operation': 'getBase64Document', 'return_type': 'String'}

PARAMETER_SCHEMA = {'document': 'document identifier to fetch'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-get_base64_document_from_database",
        node_name="Demo Get Base64 Document from Database",
        node_type=NODE_TYPE_LABEL,
        parameters={'document': 'pv!documentId'},
