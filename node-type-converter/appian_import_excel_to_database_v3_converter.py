#!/usr/bin/env python3
"""
appian_import_excel_to_database_v3_converter.py
===============================================
Converts Appian 'Import Excel to Database v3' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Version-suffixed (v3) -- almost certainly a custom/internal build. Schema is a placeholder, verify.
...
NODE_TYPE_LABEL = "Import Excel to Database v3"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'fileProcessingService', 'operation': 'importExcelToDatabase', 'return_type': 'int'}

PARAMETER_SCHEMA = {'excelDocument': 'TODO: confirm actual parameter name from your export', 'targetTable': 'TODO: confirm actual parameter name from your export'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-import_excel_to_database_v3",
        node_name="Demo Import Excel to Database v3",
        node_type=NODE_TYPE_LABEL,
        parameters={'excelDocument': 'pv!uploadedExcel', 'targetTable': '"ACCOUNT_STAGING"'},
