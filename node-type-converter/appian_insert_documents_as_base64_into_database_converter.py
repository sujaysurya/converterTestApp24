#!/usr/bin/env python3
"""
appian_insert_documents_as_base64_into_database_converter.py
============================================================
Converts Appian 'Insert Documents as Base64 into Database' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Likely custom/internal -- schema is a placeholder, verify against your export.
...
NODE_TYPE_LABEL = "Insert Documents as Base64 into Database"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'documentManagementService', 'operation': 'insertDocumentsAsBase64', 'return_type': 'boolean'}

PARAMETER_SCHEMA = {'documents': 'TODO: confirm actual parameter name', 'targetTable': 'TODO: confirm actual parameter name'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-insert_documents_as_base64_into_database",
        node_name="Demo Insert Documents as Base64 into Database",
        node_type=NODE_TYPE_LABEL,
        parameters={'documents': 'pv!documentList', 'targetTable': '"DOCUMENT_BLOB"'},
