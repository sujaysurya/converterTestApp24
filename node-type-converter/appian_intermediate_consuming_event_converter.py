#!/usr/bin/env python3
"""
appian_intermediate_consuming_event_converter.py
================================================
Converts Appian 'Intermediate Consuming Event' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Standard BPMN-style event node -- accurate at concept level.
...
NODE_TYPE_LABEL = "Intermediate Consuming Event"
NODE_CATEGORY = "EVENT_CONSUME"
EXTRA_CONFIG = {}

PARAMETER_SCHEMA = {'eventKey': 'the signal/event this node waits for', 'timeout': 'SAIL expression for the wait timeout'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-intermediate_consuming_event",
        node_name="Demo Intermediate Consuming Event",
        node_type=NODE_TYPE_LABEL,
        parameters={'eventKey': '"loan.approved"', 'timeout': 'rule!demoBusinessRule(balance: pv!currentBalance)'},
