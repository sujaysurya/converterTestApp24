#!/usr/bin/env python3
"""
appian_json_document_to_csv_converter.py
========================================
Converts Appian 'JSON Document to CSV' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Plugin/custom -- verify; confirm whether distinct from 'Json To Csv Converter' (#54) in your instance.
...
NODE_TYPE_LABEL = "JSON Document to CSV"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'fileProcessingService', 'operation': 'jsonDocumentToCsv', 'return_type': 'Document'}

PARAMETER_SCHEMA = {'jsonDocument': 'source JSON document'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-json_document_to_csv",
        node_name="Demo JSON Document to CSV",
        node_type=NODE_TYPE_LABEL,
        parameters={'jsonDocument': 'pv!jsonDoc'},
