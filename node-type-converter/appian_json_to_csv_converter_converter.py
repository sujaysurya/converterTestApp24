#!/usr/bin/env python3
"""
appian_json_to_csv_converter_converter.py
=========================================
Converts Appian 'Json To Csv Converter' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Plugin/custom -- verify; confirm whether distinct from 'JSON Document to CSV' (#13) in your instance.
...
NODE_TYPE_LABEL = "Json To Csv Converter"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'fileProcessingService', 'operation': 'jsonToCsv', 'return_type': 'Document'}

PARAMETER_SCHEMA = {'jsonData': 'source JSON data/document'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-json_to_csv_converter",
        node_name="Demo Json To Csv Converter",
        node_type=NODE_TYPE_LABEL,
        parameters={'jsonData': 'pv!jsonPayload'},
