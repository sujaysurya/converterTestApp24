#!/usr/bin/env python3
"""
appian_kafka_server_listner_daemon_v8_converter.py
==================================================
Converts Appian 'Kafka Server Listner Daemon v8' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Version-suffixed (v8), custom/internal daemon -- placeholder schema, verify heavily.
...
NODE_TYPE_LABEL = "Kafka Server Listner Daemon v8"
NODE_CATEGORY = "KAFKA_CONSUME"
EXTRA_CONFIG = {'deprecated': False}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-kafka_server_listner_daemon_v8",
        node_name="Demo Kafka Server Listner Daemon v8",
        node_type=NODE_TYPE_LABEL,
        parameters={'topic': '"account-events"', 'consumerGroup': '"pm-daemon-v8"'},
