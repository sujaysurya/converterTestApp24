#!/usr/bin/env python3
"""
appian_move_document_converter.py
=================================
Converts Appian 'Move Document' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Move Document"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'documentManagementService', 'operation': 'moveDocument', 'return_type': 'boolean'}

PARAMETER_SCHEMA = {'document': 'document to move', 'targetFolder': 'destination folder'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-move_document",
        node_name="Demo Move Document",
        node_type=NODE_TYPE_LABEL,
        parameters={'document': 'pv!documentId', 'targetFolder': '"/Archive"'},
