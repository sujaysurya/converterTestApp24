#!/usr/bin/env python3
"""
appian_or_converter.py
======================
Converts Appian 'OR' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Standard Appian inclusive gateway -- accurate.
...
EXTRA_CONFIG = {'mode': 'or'}

PARAMETER_SCHEMA = {'<branchName>': 'one parameter per inclusive outgoing flow, each a boolean condition'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        ...
        parameters={'emailAlert': 'pv!currentBalance < rule!demoBusinessRule(balance: pv!currentBalance)', 'smsAlert': 'false'},
