#!/usr/bin/env python3
"""
appian_publish_to_kafka_converter.py
====================================
Converts Appian 'Publish to Kafka' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Publish to Kafka"
NODE_CATEGORY = "KAFKA_PRODUCE"
EXTRA_CONFIG = {'bulk': False}

PARAMETER_SCHEMA = {'topic': 'target Kafka topic', 'key': 'message key', 'payload': 'message payload'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-publish_to_kafka",
        node_name="Demo Publish to Kafka",
        node_type=NODE_TYPE_LABEL,
        parameters={'topic': '"account-events"', 'key': 'pv!accountId', 'payload': 'rule!demoBusinessRule(balance: pv!currentBalance)'},
