#!/usr/bin/env python3
"""
appian_remove_group_members_converter.py
========================================
Converts Appian 'Remove Group Members' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Remove Group Members"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'identityManagementService', 'operation': 'removeGroupMembers', 'return_type': 'boolean'}

PARAMETER_SCHEMA = {'group': 'target group', 'users': 'users to remove'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-remove_group_members",
        node_name="Demo Remove Group Members",
        node_type=NODE_TYPE_LABEL,
        parameters={'group': '"Loan Approvers"', 'users': 'pv!offboardedUsers'},
