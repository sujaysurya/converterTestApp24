#!/usr/bin/env python3
"""
appian_rename_folders_converter.py
==================================
Converts Appian 'Rename Folders' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Well-documented Document Management plugin -- name is plural, may be a bulk variant; verify.
...
NODE_TYPE_LABEL = "Rename Folders"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'documentManagementService', 'operation': 'renameFolder', 'return_type': 'boolean'}

PARAMETER_SCHEMA = {'folder': 'folder to rename', 'newName': 'new folder name'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-rename_folders",
        node_name="Demo Rename Folders",
        node_type=NODE_TYPE_LABEL,
        parameters={'folder': '"/Customers/OldName"', 'newName': 'pv!newFolderName'},
