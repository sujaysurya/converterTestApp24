#!/usr/bin/env python3
"""
appian_send_email_converter.py
==============================
Converts Appian 'Send E-Mail' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Standard SMTP smart service -- accurate.
...
NODE_TYPE_LABEL = "Send E-Mail"
NODE_CATEGORY = "EMAIL"
EXTRA_CONFIG = {}

PARAMETER_SCHEMA = {'to': 'recipient(s)', 'cc': 'cc recipient(s)', 'subject': 'subject line', 'body': 'message body'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-send_email",
        node_name="Demo Send E-Mail",
        node_type=NODE_TYPE_LABEL,
        parameters={'to': 'pv!customerEmail', 'subject': '"Account Update"', 'body': 'rule!demoBusinessRule(balance: pv!currentBalance)'},
