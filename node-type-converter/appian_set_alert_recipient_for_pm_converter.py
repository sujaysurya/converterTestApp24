#!/usr/bin/env python3
"""
appian_set_alert_recipient_for_pm_converter.py
==============================================
Converts Appian 'Set Alert Recipient for PM' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Custom/internal -- 'PM' likely = Process Model admin alerting. Placeholder schema, verify heavily.
...
NODE_TYPE_LABEL = "Set Alert Recipient for PM"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'processAdminService', 'operation': 'setAlertRecipient', 'return_type': 'boolean'}

PARAMETER_SCHEMA = {'processModel': 'TODO: confirm actual parameter name', 'recipient': 'TODO: confirm actual parameter name'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-set_alert_recipient_for_pm",
        node_name="Demo Set Alert Recipient for PM",
        node_type=NODE_TYPE_LABEL,
        parameters={'processModel': '"Loan Approval Process"', 'recipient': 'pv!adminUser'},
