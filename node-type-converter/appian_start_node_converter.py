#!/usr/bin/env python3
"""
appian_start_node_converter.py
==============================
Converts Appian 'Start Node' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Start Node"
NODE_CATEGORY = "START_NODE"
EXTRA_CONFIG = {}

PARAMETER_SCHEMA = {'<inputName>': 'one parameter per process start input'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-start_node",
        node_name="Demo Start Node",
        node_type=NODE_TYPE_LABEL,
        parameters={'accountId': 'ri!accountId'},
