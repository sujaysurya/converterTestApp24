#!/usr/bin/env python3
"""
appian_start_process_converter.py
=================================
Converts Appian 'Start Process' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Standard Appian node -- accurate. Fire-and-forget, unlike Sub_PROC's call-and-wait.
...
NODE_TYPE_LABEL = "Start Process"
NODE_CATEGORY = "SUBPROCESS"
EXTRA_CONFIG = {'mode': 'start_async'}

PARAMETER_SCHEMA = {'processModel': 'target process model', 'parameters': 'SAIL expression(s) for process start parameters'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-start_process",
        node_name="Demo Start Process",
        node_type=NODE_TYPE_LABEL,
        parameters={'processModel': '"Notification Process"', 'accountId': 'pv!accountId', 'threshold': 'rule!demoBusinessRule(balance: pv!currentBalance)'},
