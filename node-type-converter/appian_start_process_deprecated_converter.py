#!/usr/bin/env python3
"""
appian_start_process_deprecated_converter.py
============================================
Converts Appian 'Start Process [Deprecated]' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Standard Appian node, deprecated -- accurate; confirm still-active usage before converting.
...
NODE_TYPE_LABEL = "Start Process [Deprecated]"
NODE_CATEGORY = "SUBPROCESS"
EXTRA_CONFIG = {'mode': 'start_async_deprecated'}

PARAMETER_SCHEMA = {'processModel': 'target process model (deprecated node -- confirm still in use)', 'parameters': 'SAIL expression(s) for process start parameters'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-start_process_deprecated",
        node_name="Demo Start Process [Deprecated]",
        node_type=NODE_TYPE_LABEL,
        parameters={'processModel': '"Legacy Audit Process"', 'accountId': 'pv!accountId'},
