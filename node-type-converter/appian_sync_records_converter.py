#!/usr/bin/env python3
"""
appian_sync_records_converter.py
================================
Converts Appian 'Sync Records' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Best-effort -- likely a custom Records-sync utility; verify.
...
NODE_TYPE_LABEL = "Sync Records"
NODE_CATEGORY = "RECORD_SYNC"
EXTRA_CONFIG = {}

PARAMETER_SCHEMA = {'recordType': 'record type to sync'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-sync_records",
        node_name="Demo Sync Records",
        node_type=NODE_TYPE_LABEL,
        parameters={'recordType': '"Account"'},
