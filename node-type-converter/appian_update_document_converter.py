#!/usr/bin/env python3
"""
appian_update_document_converter.py
===================================
Converts Appian 'Update Document' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Document Management plugin -- accurate at operation level.
...
NODE_TYPE_LABEL = "Update Document"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'documentManagementService', 'operation': 'updateDocument', 'return_type': 'boolean'}

PARAMETER_SCHEMA = {'document': 'document to update', 'newContent': 'new content/version', 'description': 'optional description'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-update_document",
        node_name="Demo Update Document",
        node_type=NODE_TYPE_LABEL,
        parameters={'document': 'pv!documentId', 'newContent': 'pv!newFileContent'},
