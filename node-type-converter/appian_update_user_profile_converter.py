#!/usr/bin/env python3
"""
appian_update_user_profile_converter.py
=======================================
Converts Appian 'Update User Profile' nodes into Java method scaffolds, with full
...
NODE_TYPE_LABEL = "Update User Profile"
NODE_CATEGORY = "SERVICE_CALL"
EXTRA_CONFIG = {'service_field': 'identityManagementService', 'operation': 'updateUserProfile', 'return_type': 'boolean'}

PARAMETER_SCHEMA = {'user': 'target user', 'profileFields': 'SAIL expr for fields to update'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-update_user_profile",
        node_name="Demo Update User Profile",
        node_type=NODE_TYPE_LABEL,
        parameters={'user': 'pv!username', 'profileFields': 'a!map(email: pv!newEmail)'},
