#!/usr/bin/env python3
"""
appian_write_to_data_store_entity_converter.py
==============================================
Converts Appian 'Write To Data Store Entity' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Standard Appian node -- accurate.
...
NODE_TYPE_LABEL = "Write To Data Store Entity"
NODE_CATEGORY = "DATA_STORE_WRITE"
EXTRA_CONFIG = {'multiplicity': 'single'}

PARAMETER_SCHEMA = {'dataStoreEntity': 'target Data Store Entity (verify)', 'valuesToStore': 'SAIL expression for the record/CDT value(s) to write'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        node_id="demo-write_to_data_store_entity",
        node_name="Demo Write To Data Store Entity",
        node_type=NODE_TYPE_LABEL,
        parameters={'dataStoreEntity': '"Account"', 'valuesToStore': 'a!map(id: pv!accountId, balance: rule!demoBusinessRule(balance: pv!currentBalance))'},
