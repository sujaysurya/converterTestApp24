#!/usr/bin/env python3
"""
appian_xor_converter.py
=======================
Converts Appian 'XOR' nodes into Java method scaffolds, with full
rule!/cons! drill-down resolution via appian_common.py.

CONFIDENCE NOTE: Standard Appian exclusive gateway -- structurally accurate; real branch names follow your export.
...
EXTRA_CONFIG = {'mode': 'xor'}

PARAMETER_SCHEMA = {'<branchName>': 'one parameter per outgoing flow, each a boolean SAIL condition expression'}
...
def _demo_node() -> NodeRecord:
    return NodeRecord(
        ...
        parameters={'approve': 'pv!currentBalance >= rule!demoBusinessRule(balance: pv!currentBalance)', 'reject': 'true'},
